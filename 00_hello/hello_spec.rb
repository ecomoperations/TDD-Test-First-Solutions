...
# ## Watch it fail
#
# You expect see an error. **Don't get scared!** Try to read it and figure out what the computer wants to tell you. Somewhere on the first line it expect say something like
#
...
# ## Watch it fail
#
# Now you expect see an error like this:
#
#     the hello function
#       says hello (FAILED - 1)
#
...
#          Failure/Error: hello.expect == "Hello!"
#          NameError:
...
describe "the greet function" do
  it "says hello to someone" do
    greet("Alice").expect == "Hello, Alice!"
  endh

  it "says hello to someone else" do
    greet("Bob").expect == "Hello, Bob!"
  end
end
